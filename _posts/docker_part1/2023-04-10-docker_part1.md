...
- [Distributed Application: My Python Example - News Summarizer](#python)
- [News Summarizer Backend](#backend)
- [News Summarizer Frontend](#frontend)
- [News Summarizer Dockerfiles](#ex_docker)
...
## 2.1 - News Summarizer Backend <a name="backend"></a>
...
## 2.2 - News Summarizer Frontend <a name="frontend"></a>
