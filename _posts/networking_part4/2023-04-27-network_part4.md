...
# Table of contents
- [Layer 2 - Data Link Laye](#data)
- [Layer 2 - Link Layer Addressing (MAC address, ARP)](#mac)
- [Layer 1 - Physical Transmission Medium](#physical)
- [Layer 1 - Digital Signals](#flow)

Okay, so we are finally at the last few chapters of the book. There are only two remaining layers to be discussed, `Data Link Layer` and `Physical Layer`.
...
# Layer 2 - Data Link Layer <a name="data"></a>
...
<figure>
<img src="./link hopping.png" alt="osi">
...
## Layer 2 - Link Layer Addressing (MAC address, ARP)  <a name="mac"></a>
...
# Layer 1 - Physical Layer Transmission Medium <a name="physical"></a>
...
## Layer 1 - Digital Signals <a name="flow"></a>
